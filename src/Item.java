...
public class Item{
	...
	*/
	...
	/** Constructs a new item object with a scanner object positioned at the beginning of an item entry in a dungeon file.
	...
	*/
	...
	/** Determines if the item object has an alias that matches the name that is provided, the aliases are listed in each item entry of a dungeon file.
	...
	*/
	...
	/** Returns the primary name for the item object, this is the first alias listed in each item entry of a dungeon file.
	...
	*/
	...
	/** Returns the list of aliases for the item object and the unit weight of the item object, which is found in each item entry of a dungeon file.
	    @return the description for that item including the list of aliases and the unit weight of that item.
	*/
	...
	/** Returns the unit weight of that item object, if the item's weight will take the user's inventory over maximum capacity then the user can't take it.
